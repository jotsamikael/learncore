export const PermissionCodes = {
  ...
  TENANT_LANGUAGE_READ: 'tenant.language.read',
  TENANT_LANGUAGE_CREATE: 'tenant.language.create',
  TENANT_LANGUAGE_UPDATE: 'tenant.language.update',
  TENANT_LANGUAGE_DELETE: 'tenant.language.delete',
