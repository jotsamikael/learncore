...
import { TenantInterceptor } from './core/helpers/tenant.interceptor';
import { SESSION_INITIALIZER } from './core/helpers/session.initializer';
import { provideApiConfiguration } from './learncoreservices/api-configuration';
...
const httpInterceptors = environment.defaultauth === 'learncore'
  ? [
...
@NgModule({
  ...
  providers: [
    ...
    ...httpInterceptors,
    ...(environment.defaultauth === 'learncore' ? [SESSION_INITIALIZER] : []),
